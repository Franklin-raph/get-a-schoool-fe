  ...
  return (
    <div>
      <div className="text-left px-7 border rounded-[15px] shadow py-6 cursor-pointer mx-1 h-[175px]">
        ...
        />
        <p className="mt-5 font-[500]">Position: <span className='font-[400]'>{job.jobTitle}</span> </p>
        <p className="mt-1 font-[500]">Salary Range: <span className='font-[400]'>{job.salaryRange}</span> </p>
      </div>
    </div>
  );
}
